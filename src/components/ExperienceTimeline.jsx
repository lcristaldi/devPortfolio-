...
const ENTRIES = [
  {
    ...
    description:
      "Shipping mission-focused tooling for the Space Development Agency. End-to-end work across React frontends, Python services, and deployment pipelines.",
    tags: ["React", "Python", "FastAPI", "TypeScript"],
